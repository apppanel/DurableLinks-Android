 ...
 *
 * @param longLink The long URL containing the Durable Link and UTM parameters.
 * This URL is parsed to extract the deep link, UTM parameters, and minimum app version.
 */
public class DurableLink public constructor(longLink: Uri) {

    /**
     * The extracted deep link from the long URL.
     * This represents the target destination for the Durable Link.
     */
    public val url: Uri
    /**
    ...
    /**
     * The minimum app version required to handle the Durable Link, extracted from the "imv" parameter.
